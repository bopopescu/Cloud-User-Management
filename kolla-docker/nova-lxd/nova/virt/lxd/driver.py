...
class LXDDriver(driver.ComputeDriver):
    ...
    def spawn(self, context, instance, image_meta, injected_files,
        ...
        LOG.debug('xxx v5 spawn container_config = %(container_config)s', {'container_config': container_config})
        LOG.debug('xxx v5 spawn config = %(config)s', {'config': profile.config})
        LOG.debug('xxx v5 spawn devices = %(devices)s', {'devices': profile.devices})
        LOG.debug('xxx v5 spawn config = %(description)s', {'description': profile.description})
