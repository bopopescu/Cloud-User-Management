...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.container.provideraccounts.service', containersService);
  ...
  function containersService(detailRoute, zun) {
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Zun::Provideraccount/' + item.id;
    }
    ...
    function getContainerPromise(identifier) {
      return zun.getProvideraccount(identifier);
    }

    /*
     * @ngdoc function
     * @name getProvideraccountsPromise
     * @description
     * Given filter/query parameters, returns a promise for the matching
     * provideraccounts.  This is used in displaying lists of containers.
     */
    function getContainersPromise(params) {
      return zun.getProvideraccounts(params).then(modifyResponse);
    }
