...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.container.provideraccounts.create.service
   * @description Service for the container create modal
   */
  angular
    .module('horizon.dashboard.container.provideraccounts')
    .factory('horizon.dashboard.container.provideraccounts.create.service', createService);
  ...
  function createService(
    ...
    function perform() {
      ...
      title = gettext('Add Provider Account');
    ...
    function submit(context) {
      ...
      return zun.createProvideraccount(context.model).then(success);
    }
