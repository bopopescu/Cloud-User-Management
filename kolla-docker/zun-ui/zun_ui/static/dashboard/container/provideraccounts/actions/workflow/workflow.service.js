...
(function() {
  ...
  angular
    ...
    .factory("horizon.dashboard.container.provideraccounts.workflow", workflow);
    ...
    function init(action, title, submitText) {
      ...
      function queryUsers(){
        ...
        function modifyUsersResponse(response) {
            ...
            form[0].tabs[0].items[2].items[0].titleMap = array;
      ...
      schema = {
        ...
        properties: {
          // info
          id: {
            title: gettext("Provideraccount ID"),
            type: "string"
          },
          user_id: {
          ...
          access_key_id: {
            title: gettext("Access Key ID"),
            type: "string"
          },
          access_key_str: {
            title: gettext("Access Key Str"),
            type: "string"
          },
          provider_id: {
      ...
      form = [
        {
          ...
          tabs: [
            {
              title: gettext("Provider Accounts"),
              help: basePath + "provideraccounts/actions/workflow/info.help.html",
              type: "section",
              htmlClass: "row",
              items: [
                {
