...
(function() {
  ...
  /**
   * @ngdoc controller
   * @name horizon.dashboard.container.provideraccounts.workflow.scheduler-hints
   * @description
  ...
  angular
    ...
    .controller('horizon.dashboard.container.provideraccounts.workflow.scheduler-hints',
