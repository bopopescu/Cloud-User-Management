...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.container.providervms.create.service
   * @description Service for the container create modal
   */
  angular
    .module('horizon.dashboard.container.providervms')
    .factory('horizon.dashboard.container.providervms.create.service', createService);
  ...
  function createService(
    ...
    function submit(context) {
      ...
      return zun.createProvidervm(context.model).then(success);
    }
