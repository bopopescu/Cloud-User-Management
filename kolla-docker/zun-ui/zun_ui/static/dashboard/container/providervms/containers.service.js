...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.container.providervms.service', containersService);
  ...
  function containersService(detailRoute, zun) {
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Zun::Providervm/' + item.id;
    }
    ...
    function getContainerPromise(identifier) {
      return zun.getProvidervm(identifier);
    }

    /*
     * @ngdoc function
     * @name getProvidervmsPromise
     * @description
     * Given filter/query parameters, returns a promise for the matching
     * providervms.  This is used in displaying lists of containers.
     */
    function getContainersPromise(params) {
      return zun.getProvidervms(params).then(modifyResponse);
    }
