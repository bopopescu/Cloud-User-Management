...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.container.instances.service', containersService);
  ...
  function containersService(detailRoute, zun) {
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Zun::Instance/' + item.id;
    }
    ...
    function getContainerPromise(identifier) {
      return zun.getInstance(identifier);
    }

    /*
     * @ngdoc function
     * @name getInstancesPromise
     * @description
     * Given filter/query parameters, returns a promise for the matching
     * instances.  This is used in displaying lists of containers.
     */
    function getContainersPromise(params) {
      return zun.getInstances(params).then(modifyResponse);
    }
