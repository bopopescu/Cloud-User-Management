...
(function() {
  ...
  function deleteService(
    ...
    function labelize(count) {
      return {
        title: ngettext('Confirm Delete Provider',
                        'Confirm Delete Providers', count),
        /* eslint-disable max-len */
        message: ngettext('You have selected "%s". Please confirm your selection. Deleted provider is not recoverable.',
                          'You have selected "%s". Please confirm your selection. Deleted providers are not recoverable.', count),
        /* eslint-enable max-len */
        submit: ngettext('Delete Provider',
                         'Delete Providers', count),
        success: ngettext('Deleted Provider: %s.',
                          'Deleted Providers: %s.', count),
        error: ngettext('Unable to delete Provider: %s.',
                        'Unable to delete Providers: %s.', count)
      };
    }
