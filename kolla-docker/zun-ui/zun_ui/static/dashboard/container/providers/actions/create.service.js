...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.container.providers.create.service
   * @description Service for the container create modal
   */
  angular
    .module('horizon.dashboard.container.providers')
    .factory('horizon.dashboard.container.providers.create.service', createService);
  ...
  function createService(
    ...
    function submit(context) {
      // context.model.name=context.model.provider_name+"_"+context.model.name;
      // context.model.id = 100;
      context.model = cleanNullProperties(context.model);
      return zun.createProvider(context.model).then(success);
    }
