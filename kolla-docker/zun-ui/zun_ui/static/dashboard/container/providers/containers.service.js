...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.container.providers.service', containersService);
  ...
  function containersService(detailRoute, zun) {
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Zun::Provider/' + item.id;
    }
    ...
    function getContainerPromise(identifier) {
      return zun.getProvider(identifier);
    }

    /*
     * @ngdoc function
     * @name getProvidersPromise
     * @description
     * Given filter/query parameters, returns a promise for the matching
     * providers.  This is used in displaying lists of containers.
     */
    function getContainersPromise(params) {
      // alert("getContainerPromise in!")
      // var res = zun.getProviders(params).then(modifyResponse);
      // alert(params.toString());
      // alert(String(params));
      // alert(JSON.stringify(params));

      return zun.getProviders(params).then(modifyResponse);
    }
