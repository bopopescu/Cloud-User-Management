...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.container.storagerates.service', containersService);
  ...
  function containersService(detailRoute, zun) {
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Zun::Storagerate/' + item.id;
    }
    ...
    function getContainerPromise(identifier) {
      return zun.getStoragerate(identifier);
    }

    /*
     * @ngdoc function
     * @name getStorageratesPromise
     * @description
     * Given filter/query parameters, returns a promise for the matching
     * storagerates.  This is used in displaying lists of containers.
     */
    function getContainersPromise(params) {
      return zun.getStoragerates(params).then(modifyResponse);
    }
