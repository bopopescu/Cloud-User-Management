...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.container.storagerates.create.service
   * @description Service for the container create modal
   */
  angular
    .module('horizon.dashboard.container.storagerates')
    .factory('horizon.dashboard.container.storagerates.create.service', createService);
  ...
  function createService(
    ...
    function perform() {
      ...
      title = gettext('Add Storage Rate');
    ...
    function submit(context) {
      ...
      return zun.createStoragerate(context.model).then(success);
    }
