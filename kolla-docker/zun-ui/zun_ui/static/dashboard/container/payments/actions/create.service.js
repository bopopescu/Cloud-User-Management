...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.container.payments.create.service
   * @description Service for the container create modal
   */
  angular
    .module('horizon.dashboard.container.payments')
    .factory('horizon.dashboard.container.payments.create.service', createService);
  ...
  function createService(
    ...
    function submit(context) {
      ...
      return zun.createPayment(context.model).then(success);
    }
