...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.container.payments.service', containersService);
  ...
  function containersService(detailRoute, zun) {
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Zun::Payment/' + item.id;
    }
    ...
    function getContainerPromise(identifier) {
      return zun.getPayment(identifier);
    }

    /*
     * @ngdoc function
     * @name getPaymentsPromise
     * @description
     * Given filter/query parameters, returns a promise for the matching
     * payments.  This is used in displaying lists of containers.
     */
    function getContainersPromise(params) {
      return zun.getPayments(params).then(modifyResponse);
    }
