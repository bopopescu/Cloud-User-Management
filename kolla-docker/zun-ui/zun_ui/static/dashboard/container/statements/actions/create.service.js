...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.container.statements.create.service
   * @description Service for the container create modal
   */
  angular
    .module('horizon.dashboard.container.statements')
    .factory('horizon.dashboard.container.statements.create.service', createService);
  ...
  function createService(
    ...
    function submit(context) {
      ...
      //alert(context.model.billing_begin_date+" from create selection");
      //alert(context.model.billing_end_date+" from create selection");

      context.model = cleanNullProperties(context.model);
      return zun.createStatement(context.model).then(success);
    }
