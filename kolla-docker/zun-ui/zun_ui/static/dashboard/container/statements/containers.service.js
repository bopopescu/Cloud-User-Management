...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.container.statements.service', containersService);
  ...
  function containersService(detailRoute, zun) {
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Zun::Statement/' + item.id;
    }
    ...
    function getContainerPromise(identifier) {
      return zun.getStatement(identifier);
    }

    /*
     * @ngdoc function
     * @name getStatementsPromise
     * @description
     * Given filter/query parameters, returns a promise for the matching
     * statements.  This is used in displaying lists of containers.
     */
    function getContainersPromise(params) {
      return zun.getStatements(params).then(modifyResponse);
    }
