...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.container.instancetypes.service', containersService);
  ...
  function containersService(detailRoute, zun) {
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Zun::Instancetype/' + item.id;
    }
    ...
    function getContainerPromise(identifier) {
      return zun.getInstancetype(identifier);
    }

    /*
     * @ngdoc function
     * @name getInstancetypesPromise
     * @description
     * Given filter/query parameters, returns a promise for the matching
     * instancetypes.  This is used in displaying lists of containers.
     */
    function getContainersPromise(params) {
      return zun.getInstancetypes(params).then(modifyResponse);
    }
