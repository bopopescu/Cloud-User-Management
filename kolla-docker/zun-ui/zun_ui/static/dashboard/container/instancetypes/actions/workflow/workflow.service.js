...
(function() {
  ...
  angular
    ...
    .factory("horizon.dashboard.container.instancetypes.workflow", workflow);
    ...
    function init(action, title, submitText) {
      ...
      schema = {
        ...
        properties: {
          ...
          memory_size: {
            title: gettext("Memory Size"),
            type: "string"
          },
          no_of_cpu: {
            title: gettext("NO Of CPU"),
            type: "string"
          },
          enable_ind: {
      ...
      form = [
        {
          ...
          tabs: [
            {
              title: gettext("Instance Types"),
              help: basePath + "instancetypes/actions/workflow/info.help.html",
              type: "section",
              htmlClass: "row",
              items: [
                {
                  ...
                  items: [
                    {
                      key: "memory_size",
                      placeholder: gettext("name of the instancetype account"),
                      required: true
                    }
                  ]
                },
