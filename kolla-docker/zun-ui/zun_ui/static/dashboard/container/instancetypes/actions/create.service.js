...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.container.instancetypes.create.service
   * @description Service for the container create modal
   */
  angular
    .module('horizon.dashboard.container.instancetypes')
    .factory('horizon.dashboard.container.instancetypes.create.service', createService);
  ...
  function createService(
    ...
    function perform() {
      ...
      title = gettext('Add Instance Type');
    ...
    function submit(context) {
      ...
      return zun.createInstancetype(context.model).then(success);
    }
