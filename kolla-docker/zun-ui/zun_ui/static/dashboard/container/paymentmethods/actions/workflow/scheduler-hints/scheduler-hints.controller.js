...
(function() {
  ...
  /**
   * @ngdoc controller
   * @name horizon.dashboard.container.paymentmethods.workflow.scheduler-hints
   * @description
  ...
  angular
    ...
    .controller('horizon.dashboard.container.paymentmethods.workflow.scheduler-hints',
