...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.container.paymentmethods.service', containersService);
  ...
  function containersService(detailRoute, zun) {
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Zun::Paymentmethod/' + item.id;
    }
    ...
    function getContainerPromise(identifier) {
      return zun.getPaymentmethod(identifier);
    }

    /*
     * @ngdoc function
     * @name getPaymentmethodsPromise
     * @description
     * Given filter/query parameters, returns a promise for the matching
     * paymentmethods.  This is used in displaying lists of containers.
     */
    function getContainersPromise(params) {
      return zun.getPaymentmethods(params).then(modifyResponse);
    }
