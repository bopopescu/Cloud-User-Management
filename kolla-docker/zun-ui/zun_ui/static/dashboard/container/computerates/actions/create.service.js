...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.container.computerates.create.service
   * @description Service for the container create modal
   */
  angular
    .module('horizon.dashboard.container.computerates')
    .factory('horizon.dashboard.container.computerates.create.service', createService);
  ...
  function createService(
    ...
    function perform() {
      ...
      title = gettext('Add Compute Rate');
    ...
    function submit(context) {
      ...
      return zun.createComputerate(context.model).then(success);
    }
