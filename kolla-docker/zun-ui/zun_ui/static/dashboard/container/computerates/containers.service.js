...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.container.computerates.service', containersService);
  ...
  function containersService(detailRoute, zun) {
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Zun::Computerate/' + item.id;
    }
    ...
    function getContainerPromise(identifier) {
      return zun.getComputerate(identifier);
    }

    /*
     * @ngdoc function
     * @name getComputeratesPromise
     * @description
     * Given filter/query parameters, returns a promise for the matching
     * computerates.  This is used in displaying lists of containers.
     */
    function getContainersPromise(params) {
      return zun.getComputerates(params).then(modifyResponse);
    }
