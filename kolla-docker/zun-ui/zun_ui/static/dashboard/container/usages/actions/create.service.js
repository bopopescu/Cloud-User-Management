...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.container.usages.create.service
   * @description Service for the container create modal
   */
  angular
    .module('horizon.dashboard.container.usages')
    .factory('horizon.dashboard.container.usages.create.service', createService);
  ...
  function createService(
    ...
    function submit(context) {
      ...
      return zun.createUsage(context.model).then(success);
    }
