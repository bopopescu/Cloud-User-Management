...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.container.usages.service', containersService);
  ...
  function containersService(detailRoute, zun) {
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Zun::Usage/' + item.id;
    }
    ...
    function getContainerPromise(identifier) {
      return zun.getUsage(identifier);
    }

    /*
     * @ngdoc function
     * @name getUsagesPromise
     * @description
     * Given filter/query parameters, returns a promise for the matching
     * usages.  This is used in displaying lists of containers.
     */
    function getContainersPromise(params) {
      return zun.getUsages(params).then(modifyResponse);
    }
