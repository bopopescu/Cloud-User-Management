...
class Instance(generic.View):
    ...
    url_regex = r'zun/instances/(?P<id>[^/]+)$'

    @rest_utils.ajax()
    def get(self, request, id):
        LOG.debug('restapi Instance xxxxxx get=%s, id=%s xxx' % (request, id))
        """Get a specific container"""
        return change_to_id(client.instance_show(request, id).to_dict())
    ...
    def delete(self, request, id):
        ...
        """
        return client.instance_delete(request, id, force=True)
    ...
    def patch(self, request, id):
        ...
        """
        args = client.instance_update(request, id, **request.DATA)
        LOG.debug('restapi inside patch Instance xxxxxx args=%s, xxx' % (args))
        return args
...
class Instances(generic.View):
    ...
    def get(self, request):
        ...
        """
        result = client.instance_list(request)
    ...
    def delete(self, request):
        ...
        for id in request.DATA:
            client.instance_delete(request, id)
    ...
    def post(self, request):
        ...
        """
        LOG.debug('instances restapi POST xxxxxx %s xxxxx %s xxx' % (request, request.DATA))
        new_container = client.instance_create(request, **request.DATA)
        LOG.debug('zunclient post "%s" and url"%s"' % (new_container.uuid, new_container.to_dict()))
        return rest_utils.CreatedResponse(
            '/api/zun/instance/%s' % new_container.uuid,
