...
_providerregion_properties = {
    'providerregion': parameter_types.providerregion_name,
...
providerregion_create = {
    'type': 'object',
    'properties': _providerregion_properties,
#    'required': ['image'],
...
query_param_rename = {
    'type': 'object',
    'properties': {
        'name': parameter_types.providerregion_name
    },
...
_providerregion_update_properties = {
    'cpu': parameter_types.cpu,
    'memory': parameter_types.memory,
}

providerregion_update = {
    'type': 'object',
    'properties': _providerregion_update_properties,
    'additionalProperties': False
}
