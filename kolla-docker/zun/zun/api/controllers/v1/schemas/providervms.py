...
_providervm_properties = {
    'providervm': parameter_types.providervm_name,
...
providervm_create = {
    'type': 'object',
    'properties': _providervm_properties,
#    'required': ['image'],
...
query_param_rename = {
    'type': 'object',
    'properties': {
        'name': parameter_types.providervm_name
    },
...
providervm_update = {
    'type': 'object',
    'properties': _providervm_update_properties,
    'additionalProperties': False
}
