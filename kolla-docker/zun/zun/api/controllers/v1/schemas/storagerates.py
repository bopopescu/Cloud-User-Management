...
_storagerate_properties = {
    'storagerate': parameter_types.storagerate_name,
...
storagerate_create = {
    'type': 'object',
    'properties': _storagerate_properties,
#    'required': ['image'],
...
query_param_rename = {
    'type': 'object',
    'properties': {
        'name': parameter_types.storagerate_name
    },
...
_storagerate_update_properties = {
    'cpu': parameter_types.cpu,
    'memory': parameter_types.memory,
}
...
storagerate_update = {
    'type': 'object',
    'properties': _storagerate_update_properties,
    'additionalProperties': False
}
