...
_provider_properties = {
    'provider': parameter_types.provider_name,
...
provider_create = {
    'type': 'object',
    'properties': _provider_properties,
#    'required': ['image'],
...
query_param_rename = {
    'type': 'object',
    'properties': {
        'name': parameter_types.provider_name
    },
...
provider_update = {
    'type': 'object',
    'properties': _provider_update_properties,
    'additionalProperties': False
}
