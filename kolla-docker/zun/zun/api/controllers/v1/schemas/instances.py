...
_instance_properties = {
    'instance': parameter_types.instance_name,
...
instance_create = {
    'type': 'object',
    'properties': _instance_properties,
#    'required': ['image'],
...
query_param_rename = {
    'type': 'object',
    'properties': {
        'name': parameter_types.instance_name
    },
...
instance_update = {
    'type': 'object',
    'properties': _instance_update_properties,
    'additionalProperties': False
}
