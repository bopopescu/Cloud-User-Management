...
_usage_properties = {
    'usage': parameter_types.usage_name,
...
query_param_rename = {
    'type': 'object',
    'properties': {
        'name': parameter_types.usage_name
    },
...
usage_update = {
    'type': 'object',
    'properties': _usage_update_properties,
    'additionalProperties': False
}
