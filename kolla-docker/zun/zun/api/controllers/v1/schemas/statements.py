...
_statement_properties = {
    'statement': parameter_types.statement_name,
...
query_param_rename = {
    'type': 'object',
    'properties': {
        'name': parameter_types.statement_name
    },
...
statement_update = {
    'type': 'object',
    'properties': _statement_update_properties,
    'additionalProperties': False
}
