...
_provideraccount_properties = {
    'provideraccount': parameter_types.provideraccount_name,
...
provideraccount_create = {
    'type': 'object',
    'properties': _provideraccount_properties,
#    'required': ['image'],
...
query_param_rename = {
    'type': 'object',
    'properties': {
        'name': parameter_types.provideraccount_name
    },
...
_provideraccount_update_properties = {
    'cpu': parameter_types.cpu,
    'memory': parameter_types.memory,
}

provideraccount_update = {
    'type': 'object',
    'properties': _provideraccount_update_properties,
    'additionalProperties': False
}
