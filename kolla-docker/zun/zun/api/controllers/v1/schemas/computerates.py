...
_computerate_properties = {
    'computerate': parameter_types.computerate_name,
...
computerate_create = {
    'type': 'object',
    'properties': _computerate_properties,
#    'required': ['image'],
...
query_param_rename = {
    'type': 'object',
    'properties': {
        'name': parameter_types.computerate_name
    },
...
_computerate_update_properties = {
    'cpu': parameter_types.cpu,
    'memory': parameter_types.memory,
}
...
computerate_update = {
    'type': 'object',
    'properties': _computerate_update_properties,
    'additionalProperties': False
}
