...
_instancetype_properties = {
    'instancetype': parameter_types.instancetype_name,
...
instancetype_create = {
    'type': 'object',
    'properties': _instancetype_properties,
#    'required': ['image'],
...
query_param_rename = {
    'type': 'object',
    'properties': {
        'name': parameter_types.instancetype_name
    },
...
_instancetype_update_properties = {
    'cpu': parameter_types.cpu,
    'memory': parameter_types.memory,
}
...
instancetype_update = {
    'type': 'object',
    'properties': _instancetype_update_properties,
    'additionalProperties': False
}
