...
_paymentmethod_properties = {
    'paymentmethod': parameter_types.paymentmethod_name,
...
paymentmethod_create = {
    'type': 'object',
    'properties': _paymentmethod_properties,
#    'required': ['image'],
...
query_param_rename = {
    'type': 'object',
    'properties': {
        'name': parameter_types.paymentmethod_name
    },
...
_paymentmethod_update_properties = {
    'cpu': parameter_types.cpu,
    'memory': parameter_types.memory,
}
...
paymentmethod_update = {
    'type': 'object',
    'properties': _paymentmethod_update_properties,
    'additionalProperties': False
}
