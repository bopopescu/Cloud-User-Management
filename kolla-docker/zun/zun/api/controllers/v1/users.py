...
class ContainersController(base.Controller):
    ...
    def get_all(self, **kwargs):
        ...
        """
        LOG.info('**kwargs **kwargs **kwargs **kwargs **kwargs **kwargs **kwargs **kwargs **kwargs **kwargs **kwargs **kwargs **kwargs **kwargs')
    ...
    def _get_containers_collection(self, **kwargs):
        ...
        LOG.info("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
        LOG.info(xx)
        return xx
    ...
    #@validation.validated(schema.user_create)
