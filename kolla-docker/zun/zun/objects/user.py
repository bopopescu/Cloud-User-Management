...
class User(base.ZunPersistentObject, base.ZunObject):
    ...
    fields = {
        ...
        'passreset_url': fields.StringField(nullable=True),
        'activation_url': fields.StringField(nullable=True),
        'activation_expir_date': fields.DateTimeField(nullable=True),
        'passreset_expir_date': fields.DateTimeField(nullable=True),
        'last_login_time': fields.DateTimeField(nullable=True),
        'last_success_login_ip': fields.StringField(nullable=True),
        'last_failed_login_ip': fields.StringField(nullable=True),
    }
    ...
    def save(self, context=None):
        ...
        LOG.info("ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss")
        LOG.info(context)
        LOG.info(self.uuid)
        LOG.info(updates)
