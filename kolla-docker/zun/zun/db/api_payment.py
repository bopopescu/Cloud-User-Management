...
@profiler.trace("db")
def list_payments(context, filters=None, limit=None, marker=None,
                    sort_key=None, sort_dir=None):
    """List matching payments.

    Return a list of the specified columns for all payments that match
    ...
    """
    return _get_dbdriver_instance().list_payments(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_payment(context, values):
    """Create a new payment.

    :param context: The security context
    :param values: A dict containing several items used to identify
                   and track the payment, and several dicts which are
                   passed
                   into the Drivers when managing this payment. For
                   example:
                   ::
                    {
    ...
    :returns: A payment.
    """
    return _get_dbdriver_instance().create_payment(context, values)


@profiler.trace("db")
def get_payment_by_uuid(context, payment_uuid):
    """Return a payment.

    :param context: The security context
    :param payment_uuid: The uuid of a payment.
    :returns: A payment.
    """
    return _get_dbdriver_instance().get_payment_by_uuid(
        context, payment_uuid)


@profiler.trace("db")
def get_payment_by_name(context, payment_name):
    """Return a payment.

    :param context: The security context
    :param payment_name: The name of a payment.
    :returns: A payment.
    """
    return _get_dbdriver_instance().get_payment_by_name(
        context, payment_name)


@profiler.trace("db")
def destroy_payment(context, payment_id):
    """Destroy a payment and all associated interfaces.

    :param context: Request context
    :param payment_id: The id or uuid of a payment.
    """
    return _get_dbdriver_instance().destroy_payment(context, payment_id)


@profiler.trace("db")
def update_payment(context, payment_id, values):
    """Update properties of a payment.
    ...
    """
    process_date("payment_date", values)
    return _get_dbdriver_instance().update_payment(
        context, payment_id, values)
...
@profiler.trace("db")
def list_resource_payments(context, filters=None, limit=None, marker=None,
                            sort_key=None, sort_dir=None):
    """Get matching resource payments.

    Return a list of the specified columns for all resource payments that
    match the specified filters.
    :param context: The security context
    :param filters: Filters to apply. Defaults to None.
    :param limit: Maximum number of resource payments to return.
    :param marker: the last item of the previous page; we
                    return the next
    :param sort_key: Attribute by which results should be sorted.
                    (asc, desc)
    :returns: A list of tuples of the specified columns.
    """
    return _get_dbdriver_instance().list_resource_payments(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_resource_payment(context, values):
    """Create a new resource payment.

    :param context: The security context
    :param values: A dict containing several items used to identify and
                   track the resource payment, and several dicts which are
                   passed into the Drivers when managing this resource
                   payment.
    :returns: A resource payment.
    """
    return _get_dbdriver_instance().create_resource_payment(context, values)


@profiler.trace("db")
def get_resource_payment(context, payment_ident):
    """Return a resource payment.

    :param context: The security context
    :param payment_ident: The uuid or name of a resource payment.
    :returns: A resource payment.
    """
    return _get_dbdriver_instance().get_resource_payment(
        context, payment_ident)


@profiler.trace("db")
def destroy_resource_payment(context, payment_id):
    """Destroy a resource payment and all associated interfaces.

    :param context: Request context
    :param payment_id: The id or uuid of a resource payment.
    """
    return _get_dbdriver_instance().destroy_resource_payment(
        context, payment_id)


@profiler.trace("db")
def update_resource_payment(context, payment_id, values):
    """Update properties of a resource payment.

    :context: Request context
    :param payment_id: The id or uuid of a resource payment.
    :values: The properties to be updated
    :returns: A resource payment.
    :raises: ResourcePaymentNotFound
    """
    return _get_dbdriver_instance().update_resource_payment(
        context, payment_id, values)
...
@profiler.trace("db")
def create_inventory(context, payment_id, values):
    """Create a new inventory.

    :param context: The security context
    :param payment_id: The id of a resource payment.
    :param values: A dict containing several items used to identify
