...
@profiler.trace("db")
def list_usages(context, filters=None, limit=None, marker=None,
                    sort_key=None, sort_dir=None):
    """List matching usages.

    Return a list of the specified columns for all usages that match
    the specified filters.
    :param context: The security context
    :param filters: Filters to apply. Defaults to None.
    :param limit: Maximum number of usages to return.
    ...
    """
    return _get_dbdriver_instance().list_usages(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_usage(context, values):
    """Create a new usage.

    :param context: The security context
    :param values: A dict containing several items used to identify
                   and track the usage, and several dicts which are
                   passed
                   into the Drivers when managing this usage. For
                   example:
                   ::
                    {
    ...
    :returns: A usage.
    """
    return _get_dbdriver_instance().create_usage(context, values)


@profiler.trace("db")
def get_usage_by_uuid(context, usage_uuid):
    """Return a usage.

    :param context: The security context
    :param usage_uuid: The uuid of a usage.
    :returns: A usage.
    """
    return _get_dbdriver_instance().get_usage_by_uuid(
        context, usage_uuid)


@profiler.trace("db")
def get_usage_by_name(context, usage_name):
    """Return a usage.

    :param context: The security context
    :param usage_name: The name of a usage.
    :returns: A usage.
    """
    return _get_dbdriver_instance().get_usage_by_name(
        context, usage_name)


@profiler.trace("db")
def destroy_usage(context, usage_id):
    """Destroy a usage and all associated interfaces.

    :param context: Request context
    :param usage_id: The id or uuid of a usage.
    """
    return _get_dbdriver_instance().destroy_usage(context, usage_id)


@profiler.trace("db")
def update_usage(context, usage_id, values):
    """Update properties of a usage.
    ...
    process_date("stop_time", values)
    return _get_dbdriver_instance().update_usage(
        context, usage_id, values)
...
@profiler.trace("db")
def list_resource_usages(context, filters=None, limit=None, marker=None,
                            sort_key=None, sort_dir=None):
    """Get matching resource usages.

    Return a list of the specified columns for all resource usages that
    match the specified filters.
    :param context: The security context
    :param filters: Filters to apply. Defaults to None.
    :param limit: Maximum number of resource usages to return.
    :param marker: the last item of the previous page; we
                    return the next
    :param sort_key: Attribute by which results should be sorted.
                    (asc, desc)
    :returns: A list of tuples of the specified columns.
    """
    return _get_dbdriver_instance().list_resource_usages(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_resource_usage(context, values):
    """Create a new resource usage.

    :param context: The security context
    :param values: A dict containing several items used to identify and
                   track the resource usage, and several dicts which are
                   passed into the Drivers when managing this resource
                   usage.
    :returns: A resource usage.
    """
    return _get_dbdriver_instance().create_resource_usage(context, values)


@profiler.trace("db")
def get_resource_usage(context, usage_ident):
    """Return a resource usage.

    :param context: The security context
    :param usage_ident: The uuid or name of a resource usage.
    :returns: A resource usage.
    """
    return _get_dbdriver_instance().get_resource_usage(
        context, usage_ident)


@profiler.trace("db")
def destroy_resource_usage(context, usage_id):
    """Destroy a resource usage and all associated interfaces.

    :param context: Request context
    :param usage_id: The id or uuid of a resource usage.
    """
    return _get_dbdriver_instance().destroy_resource_usage(
        context, usage_id)


@profiler.trace("db")
def update_resource_usage(context, usage_id, values):
    """Update properties of a resource usage.

    :context: Request context
    :param usage_id: The id or uuid of a resource usage.
    :values: The properties to be updated
    :returns: A resource usage.
    :raises: ResourceUsageNotFound
    """
    return _get_dbdriver_instance().update_resource_usage(
        context, usage_id, values)
...
@profiler.trace("db")
def create_inventory(context, usage_id, values):
    """Create a new inventory.

    :param context: The security context
    :param usage_id: The id of a resource usage.
    :param values: A dict containing several items used to identify
