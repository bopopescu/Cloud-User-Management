...
@profiler.trace("db")
def list_instances(context, filters=None, limit=None, marker=None,
                    sort_key=None, sort_dir=None):
    """List matching instances.

    Return a list of the specified columns for all instances that match
    ...
    """
    return _get_dbdriver_instance().list_instances(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_instance(context, values):
    """Create a new instance.

    :param context: The security context
    :param values: A dict containing several items used to identify
                   and track the instance, and several dicts which are
                   passed
                   into the Drivers when managing this instance. For
                   example:
                   ::
                    {
    ...
    :returns: A instance.
    """
    return _get_dbdriver_instance().create_instance(context, values)


@profiler.trace("db")
def get_instance_by_uuid(context, instance_uuid):
    """Return a instance.
    ...
    :returns: A instance.
    """
    return _get_dbdriver_instance().get_instance_by_uuid(
        context, instance_uuid)


@profiler.trace("db")
def get_instance_by_name(context, instance_name):
    """Return a instance.

    :param context: The security context
    :param instance_name: The name of a instance.
    :returns: A instance.
    """
    return _get_dbdriver_instance().get_instance_by_name(
        context, instance_name)


@profiler.trace("db")
def destroy_instance(context, instance_id):
    """Destroy a instance and all associated interfaces.

    :param context: Request context
    :param instance_id: The id or uuid of a instance.
    """
    return _get_dbdriver_instance().destroy_instance(context, instance_id)


@profiler.trace("db")
def update_instance(context, instance_id, values):
    """Update properties of a instance.
    ...
    """
    process_date("current_status_time", values)
    process_date("create_time", values)
    return _get_dbdriver_instance().update_instance(
...
@profiler.trace("db")
def list_resource_instances(context, filters=None, limit=None, marker=None,
                            sort_key=None, sort_dir=None):
    """Get matching resource instances.

    Return a list of the specified columns for all resource instances that
    match the specified filters.
    :param context: The security context
    :param filters: Filters to apply. Defaults to None.
    :param limit: Maximum number of resource instances to return.
    :param marker: the last item of the previous page; we
                    return the next
    :param sort_key: Attribute by which results should be sorted.
                    (asc, desc)
    :returns: A list of tuples of the specified columns.
    """
    return _get_dbdriver_instance().list_resource_instances(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_resource_instance(context, values):
    """Create a new resource instance.

    :param context: The security context
    :param values: A dict containing several items used to identify and
                   track the resource instance, and several dicts which are
                   passed into the Drivers when managing this resource
                   instance.
    :returns: A resource instance.
    """
    return _get_dbdriver_instance().create_resource_instance(context, values)


@profiler.trace("db")
def get_resource_instance(context, instance_ident):
    """Return a resource instance.

    :param context: The security context
    :param instance_ident: The uuid or name of a resource instance.
    :returns: A resource instance.
    """
    return _get_dbdriver_instance().get_resource_instance(
        context, instance_ident)


@profiler.trace("db")
def destroy_resource_instance(context, instance_id):
    """Destroy a resource instance and all associated interfaces.

    :param context: Request context
    :param instance_id: The id or uuid of a resource instance.
    """
    return _get_dbdriver_instance().destroy_resource_instance(
        context, instance_id)


@profiler.trace("db")
def update_resource_instance(context, instance_id, values):
    """Update properties of a resource instance.

    :context: Request context
    :param instance_id: The id or uuid of a resource instance.
    :values: The properties to be updated
    :returns: A resource instance.
    :raises: ResourceInstanceNotFound
    """
    return _get_dbdriver_instance().update_resource_instance(
        context, instance_id, values)
...
@profiler.trace("db")
def create_inventory(context, instance_id, values):
    """Create a new inventory.

    :param context: The security context
    :param instance_id: The id of a resource instance.
    :param values: A dict containing several items used to identify
