...
@profiler.trace("db")
def list_computerates(context, filters=None, limit=None, marker=None,
                    sort_key=None, sort_dir=None):
    """List matching computerates.

    Return a list of the specified columns for all computerates that match
    the specified filters.
    :param context: The security context
    :param filters: Filters to apply. Defaults to None.
    :param limit: Maximum number of computerates to return.
    ...
    """
    return _get_dbdriver_instance().list_computerates(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_computerate(context, values):
    """Create a new computerate.

    :param context: The security context
    :param values: A dict containing several items used to identify
                   and track the computerate, and several dicts which are
                   passed
                   into the Drivers when managing this computerate. For
                   example:
                   ::
                    {
    ...
    :returns: A computerate.
    """
    return _get_dbdriver_instance().create_computerate(context, values)


@profiler.trace("db")
def get_computerate_by_uuid(context, computerate_uuid):
    """Return a computerate.

    :param context: The security context
    :param computerate_uuid: The uuid of a computerate.
    :returns: A computerate.
    """
    return _get_dbdriver_instance().get_computerate_by_uuid(
        context, computerate_uuid)


@profiler.trace("db")
def get_computerate_by_name(context, computerate_name):
    """Return a computerate.

    :param context: The security context
    :param computerate_name: The name of a computerate.
    :returns: A computerate.
    """
    return _get_dbdriver_instance().get_computerate_by_name(
        context, computerate_name)


@profiler.trace("db")
def destroy_computerate(context, computerate_id):
    """Destroy a computerate and all associated interfaces.

    :param context: Request context
    :param computerate_id: The id or uuid of a computerate.
    """
    return _get_dbdriver_instance().destroy_computerate(context, computerate_id)


@profiler.trace("db")
def update_computerate(context, computerate_id, values):
    """Update properties of a computerate.
    ...
    return _get_dbdriver_instance().update_computerate(
        context, computerate_id, values)
...
@profiler.trace("db")
def list_resource_computerates(context, filters=None, limit=None, marker=None,
                            sort_key=None, sort_dir=None):
    """Get matching resource computerates.

    Return a list of the specified columns for all resource computerates that
    match the specified filters.
    :param context: The security context
    :param filters: Filters to apply. Defaults to None.
    :param limit: Maximum number of resource computerates to return.
    :param marker: the last item of the previous page; we
                    return the next
    :param sort_key: Attribute by which results should be sorted.
                    (asc, desc)
    :returns: A list of tuples of the specified columns.
    """
    return _get_dbdriver_instance().list_resource_computerates(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_resource_computerate(context, values):
    """Create a new resource computerate.

    :param context: The security context
    :param values: A dict containing several items used to identify and
                   track the resource computerate, and several dicts which are
                   passed into the Drivers when managing this resource
                   computerate.
    :returns: A resource computerate.
    """
    return _get_dbdriver_instance().create_resource_computerate(context, values)


@profiler.trace("db")
def get_resource_computerate(context, computerate_ident):
    """Return a resource computerate.

    :param context: The security context
    :param computerate_ident: The uuid or name of a resource computerate.
    :returns: A resource computerate.
    """
    return _get_dbdriver_instance().get_resource_computerate(
        context, computerate_ident)


@profiler.trace("db")
def destroy_resource_computerate(context, computerate_id):
    """Destroy a resource computerate and all associated interfaces.

    :param context: Request context
    :param computerate_id: The id or uuid of a resource computerate.
    """
    return _get_dbdriver_instance().destroy_resource_computerate(
        context, computerate_id)


@profiler.trace("db")
def update_resource_computerate(context, computerate_id, values):
    """Update properties of a resource computerate.

    :context: Request context
    :param computerate_id: The id or uuid of a resource computerate.
    :values: The properties to be updated
    :returns: A resource computerate.
    :raises: ResourceComputerateNotFound
    """
    return _get_dbdriver_instance().update_resource_computerate(
        context, computerate_id, values)
...
@profiler.trace("db")
def create_inventory(context, computerate_id, values):
    """Create a new inventory.

    :param context: The security context
    :param computerate_id: The id of a resource computerate.
    :param values: A dict containing several items used to identify
