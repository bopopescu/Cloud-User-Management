...
@profiler.trace("db")
def list_instancetypes(context, filters=None, limit=None, marker=None,
                    sort_key=None, sort_dir=None):
    """List matching instancetypes.

    Return a list of the specified columns for all instancetypes that match
    the specified filters.
    :param context: The security context
    :param filters: Filters to apply. Defaults to None.
    :param limit: Maximum number of instancetypes to return.
    ...
    """
    return _get_dbdriver_instance().list_instancetypes(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_instancetype(context, values):
    """Create a new instancetype.

    :param context: The security context
    :param values: A dict containing several items used to identify
                   and track the instancetype, and several dicts which are
                   passed
                   into the Drivers when managing this instancetype. For
                   example:
                   ::
                    {
    ...
    :returns: A instancetype.
    """
    return _get_dbdriver_instance().create_instancetype(context, values)


@profiler.trace("db")
def get_instancetype_by_uuid(context, instancetype_uuid):
    """Return a instancetype.

    :param context: The security context
    :param instancetype_uuid: The uuid of a instancetype.
    :returns: A instancetype.
    """
    return _get_dbdriver_instance().get_instancetype_by_uuid(
        context, instancetype_uuid)


@profiler.trace("db")
def get_instancetype_by_name(context, instancetype_name):
    """Return a instancetype.

    :param context: The security context
    :param instancetype_name: The name of a instancetype.
    :returns: A instancetype.
    """
    return _get_dbdriver_instance().get_instancetype_by_name(
        context, instancetype_name)


@profiler.trace("db")
def destroy_instancetype(context, instancetype_id):
    """Destroy a instancetype and all associated interfaces.

    :param context: Request context
    :param instancetype_id: The id or uuid of a instancetype.
    """
    return _get_dbdriver_instance().destroy_instancetype(context, instancetype_id)


@profiler.trace("db")
def update_instancetype(context, instancetype_id, values):
    """Update properties of a instancetype.
    ...
    """
    process_date("start_date", values)
    process_date("end_date", values)
    return _get_dbdriver_instance().update_instancetype(
        context, instancetype_id, values)
...
@profiler.trace("db")
def list_resource_instancetypes(context, filters=None, limit=None, marker=None,
                            sort_key=None, sort_dir=None):
    """Get matching resource instancetypes.

    Return a list of the specified columns for all resource instancetypes that
    match the specified filters.
    :param context: The security context
    :param filters: Filters to apply. Defaults to None.
    :param limit: Maximum number of resource instancetypes to return.
    :param marker: the last item of the previous page; we
                    return the next
    :param sort_key: Attribute by which results should be sorted.
                    (asc, desc)
    :returns: A list of tuples of the specified columns.
    """
    return _get_dbdriver_instance().list_resource_instancetypes(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_resource_instancetype(context, values):
    """Create a new resource instancetype.

    :param context: The security context
    :param values: A dict containing several items used to identify and
                   track the resource instancetype, and several dicts which are
                   passed into the Drivers when managing this resource
                   instancetype.
    :returns: A resource instancetype.
    """
    return _get_dbdriver_instance().create_resource_instancetype(context, values)


@profiler.trace("db")
def get_resource_instancetype(context, instancetype_ident):
    """Return a resource instancetype.

    :param context: The security context
    :param instancetype_ident: The uuid or name of a resource instancetype.
    :returns: A resource instancetype.
    """
    return _get_dbdriver_instance().get_resource_instancetype(
        context, instancetype_ident)


@profiler.trace("db")
def destroy_resource_instancetype(context, instancetype_id):
    """Destroy a resource instancetype and all associated interfaces.

    :param context: Request context
    :param instancetype_id: The id or uuid of a resource instancetype.
    """
    return _get_dbdriver_instance().destroy_resource_instancetype(
        context, instancetype_id)


@profiler.trace("db")
def update_resource_instancetype(context, instancetype_id, values):
    """Update properties of a resource instancetype.

    :context: Request context
    :param instancetype_id: The id or uuid of a resource instancetype.
    :values: The properties to be updated
    :returns: A resource instancetype.
    :raises: ResourceInstancetypeNotFound
    """
    return _get_dbdriver_instance().update_resource_instancetype(
        context, instancetype_id, values)
...
@profiler.trace("db")
def create_inventory(context, instancetype_id, values):
    """Create a new inventory.

    :param context: The security context
    :param instancetype_id: The id of a resource instancetype.
    :param values: A dict containing several items used to identify
