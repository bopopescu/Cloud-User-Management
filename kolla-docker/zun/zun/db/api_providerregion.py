...
@profiler.trace("db")
def list_providerregions(context, filters=None, limit=None, marker=None,
                    sort_key=None, sort_dir=None):
    """List matching providerregions.

    Return a list of the specified columns for all providerregions that match
    the specified filters.
    :param context: The security context
    :param filters: Filters to apply. Defaults to None.
    :param limit: Maximum number of providerregions to return.
    ...
    """
    return _get_dbdriver_instance().list_providerregions(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_providerregion(context, values):
    """Create a new providerregion.

    :param context: The security context
    :param values: A dict containing several items used to identify
                   and track the providerregion, and several dicts which are
                   passed
                   into the Drivers when managing this providerregion. For
                   example:
                   ::
                    {
    ...
    :returns: A providerregion.
    """
    return _get_dbdriver_instance().create_providerregion(context, values)


@profiler.trace("db")
def get_providerregion_by_uuid(context, providerregion_uuid):
    """Return a providerregion.

    :param context: The security context
    :param providerregion_uuid: The uuid of a providerregion.
    :returns: A providerregion.
    """
    return _get_dbdriver_instance().get_providerregion_by_uuid(
        context, providerregion_uuid)


@profiler.trace("db")
def get_providerregion_by_name(context, providerregion_name):
    """Return a providerregion.

    :param context: The security context
    :param providerregion_name: The name of a providerregion.
    :returns: A providerregion.
    """
    return _get_dbdriver_instance().get_providerregion_by_name(
        context, providerregion_name)


@profiler.trace("db")
def destroy_providerregion(context, providerregion_id):
    """Destroy a providerregion and all associated interfaces.

    :param context: Request context
    :param providerregion_id: The id or uuid of a providerregion.
    """
    return _get_dbdriver_instance().destroy_providerregion(context, providerregion_id)


@profiler.trace("db")
def update_providerregion(context, providerregion_id, values):
    """Update properties of a providerregion.
    ...
    """
    return _get_dbdriver_instance().update_providerregion(
        context, providerregion_id, values)
...
@profiler.trace("db")
def list_resource_providerregions(context, filters=None, limit=None, marker=None,
                            sort_key=None, sort_dir=None):
    """Get matching resource providerregions.

    Return a list of the specified columns for all resource providerregions that
    match the specified filters.
    :param context: The security context
    :param filters: Filters to apply. Defaults to None.
    :param limit: Maximum number of resource providerregions to return.
    :param marker: the last item of the previous page; we
                    return the next
    :param sort_key: Attribute by which results should be sorted.
                    (asc, desc)
    :returns: A list of tuples of the specified columns.
    """
    return _get_dbdriver_instance().list_resource_providerregions(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_resource_providerregion(context, values):
    """Create a new resource providerregion.

    :param context: The security context
    :param values: A dict containing several items used to identify and
                   track the resource providerregion, and several dicts which are
                   passed into the Drivers when managing this resource
                   providerregion.
    :returns: A resource providerregion.
    """
    return _get_dbdriver_instance().create_resource_providerregion(context, values)


@profiler.trace("db")
def get_resource_providerregion(context, providerregion_ident):
    """Return a resource providerregion.

    :param context: The security context
    :param providerregion_ident: The uuid or name of a resource providerregion.
    :returns: A resource providerregion.
    """
    return _get_dbdriver_instance().get_resource_providerregion(
        context, providerregion_ident)


@profiler.trace("db")
def destroy_resource_providerregion(context, providerregion_id):
    """Destroy a resource providerregion and all associated interfaces.

    :param context: Request context
    :param providerregion_id: The id or uuid of a resource providerregion.
    """
    return _get_dbdriver_instance().destroy_resource_providerregion(
        context, providerregion_id)


@profiler.trace("db")
def update_resource_providerregion(context, providerregion_id, values):
    """Update properties of a resource providerregion.

    :context: Request context
    :param providerregion_id: The id or uuid of a resource providerregion.
    :values: The properties to be updated
    :returns: A resource providerregion.
    :raises: ResourceProviderregionNotFound
    """
    return _get_dbdriver_instance().update_resource_providerregion(
        context, providerregion_id, values)
...
@profiler.trace("db")
def create_inventory(context, providerregion_id, values):
    """Create a new inventory.

    :param context: The security context
    :param providerregion_id: The id of a resource providerregion.
    :param values: A dict containing several items used to identify
