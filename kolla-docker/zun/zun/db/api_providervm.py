...
@profiler.trace("db")
def list_providervms(context, filters=None, limit=None, marker=None,
                    sort_key=None, sort_dir=None):
    """List matching providervms.

    Return a list of the specified columns for all providervms that match
    the specified filters.
    :param context: The security context
    :param filters: Filters to apply. Defaults to None.
    :param limit: Maximum number of providervms to return.
    ...
    """
    return _get_dbdriver_instance().list_providervms(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_providervm(context, values):
    """Create a new providervm.

    :param context: The security context
    :param values: A dict containing several items used to identify
                   and track the providervm, and several dicts which are
                   passed
                   into the Drivers when managing this providervm. For
                   example:
                   ::
                    {
    ...
    :returns: A providervm.
    """
    return _get_dbdriver_instance().create_providervm(context, values)


@profiler.trace("db")
def get_providervm_by_uuid(context, providervm_uuid):
    """Return a providervm.

    :param context: The security context
    :param providervm_uuid: The uuid of a providervm.
    :returns: A providervm.
    """
    return _get_dbdriver_instance().get_providervm_by_uuid(
        context, providervm_uuid)


@profiler.trace("db")
def get_providervm_by_name(context, providervm_name):
    """Return a providervm.

    :param context: The security context
    :param providervm_name: The name of a providervm.
    :returns: A providervm.
    """
    return _get_dbdriver_instance().get_providervm_by_name(
        context, providervm_name)


@profiler.trace("db")
def destroy_providervm(context, providervm_id):
    """Destroy a providervm and all associated interfaces.

    :param context: Request context
    :param providervm_id: The id or uuid of a providervm.
    """
    return _get_dbdriver_instance().destroy_providervm(context, providervm_id)


@profiler.trace("db")
def update_providervm(context, providervm_id, values):
    """Update properties of a providervm.
    ...
    """
    process_date("create_date", values)
    return _get_dbdriver_instance().update_providervm(
        context, providervm_id, values)
...
@profiler.trace("db")
def list_resource_providervms(context, filters=None, limit=None, marker=None,
                            sort_key=None, sort_dir=None):
    """Get matching resource providervms.

    Return a list of the specified columns for all resource providervms that
    match the specified filters.
    :param context: The security context
    :param filters: Filters to apply. Defaults to None.
    :param limit: Maximum number of resource providervms to return.
    :param marker: the last item of the previous page; we
                    return the next
    :param sort_key: Attribute by which results should be sorted.
                    (asc, desc)
    :returns: A list of tuples of the specified columns.
    """
    return _get_dbdriver_instance().list_resource_providervms(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_resource_providervm(context, values):
    """Create a new resource providervm.

    :param context: The security context
    :param values: A dict containing several items used to identify and
                   track the resource providervm, and several dicts which are
                   passed into the Drivers when managing this resource
                   providervm.
    :returns: A resource providervm.
    """
    return _get_dbdriver_instance().create_resource_providervm(context, values)


@profiler.trace("db")
def get_resource_providervm(context, providervm_ident):
    """Return a resource providervm.

    :param context: The security context
    :param providervm_ident: The uuid or name of a resource providervm.
    :returns: A resource providervm.
    """
    return _get_dbdriver_instance().get_resource_providervm(
        context, providervm_ident)


@profiler.trace("db")
def destroy_resource_providervm(context, providervm_id):
    """Destroy a resource providervm and all associated interfaces.

    :param context: Request context
    :param providervm_id: The id or uuid of a resource providervm.
    """
    return _get_dbdriver_instance().destroy_resource_providervm(
        context, providervm_id)


@profiler.trace("db")
def update_resource_providervm(context, providervm_id, values):
    """Update properties of a resource providervm.

    :context: Request context
    :param providervm_id: The id or uuid of a resource providervm.
    :values: The properties to be updated
    :returns: A resource providervm.
    :raises: ResourceProvidervmNotFound
    """
    return _get_dbdriver_instance().update_resource_providervm(
        context, providervm_id, values)
...
@profiler.trace("db")
def create_inventory(context, providervm_id, values):
    """Create a new inventory.

    :param context: The security context
    :param providervm_id: The id of a resource providervm.
    :param values: A dict containing several items used to identify
