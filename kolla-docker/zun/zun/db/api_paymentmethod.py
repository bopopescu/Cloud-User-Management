...
@profiler.trace("db")
def list_paymentmethods(context, filters=None, limit=None, marker=None,
                    sort_key=None, sort_dir=None):
    """List matching paymentmethods.

    Return a list of the specified columns for all paymentmethods that match
    the specified filters.
    :param context: The security context
    :param filters: Filters to apply. Defaults to None.
    :param limit: Maximum number of paymentmethods to return.
    ...
    """
    return _get_dbdriver_instance().list_paymentmethods(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_paymentmethod(context, values):
    """Create a new paymentmethod.

    :param context: The security context
    :param values: A dict containing several items used to identify
                   and track the paymentmethod, and several dicts which are
                   passed
                   into the Drivers when managing this paymentmethod. For
                   example:
                   ::
                    {
    ...
    """
    return _get_dbdriver_instance().create_paymentmethod(context, values)


@profiler.trace("db")
def get_paymentmethod_by_uuid(context, paymentmethod_uuid):
    """Return a paymentmethod.

    :param context: The security context
    :param paymentmethod_uuid: The uuid of a paymentmethod.
    :returns: A paymentmethod.
    """
    return _get_dbdriver_instance().get_paymentmethod_by_uuid(
        context, paymentmethod_uuid)


@profiler.trace("db")
def get_paymentmethod_by_name(context, paymentmethod_name):
    """Return a paymentmethod.

    :param context: The security context
    :param paymentmethod_name: The name of a paymentmethod.
    :returns: A paymentmethod.
    """
    return _get_dbdriver_instance().get_paymentmethod_by_name(
        context, paymentmethod_name)


@profiler.trace("db")
def destroy_paymentmethod(context, paymentmethod_id):
    """Destroy a paymentmethod and all associated interfaces.

    :param context: Request context
    :param paymentmethod_id: The id or uuid of a paymentmethod.
    """
    return _get_dbdriver_instance().destroy_paymentmethod(context, paymentmethod_id)


@profiler.trace("db")
def update_paymentmethod(context, paymentmethod_id, values):
    """Update properties of a paymentmethod.
    ...
    """
    return _get_dbdriver_instance().update_paymentmethod(
        context, paymentmethod_id, values)
...
@profiler.trace("db")
def list_resource_paymentmethods(context, filters=None, limit=None, marker=None,
                            sort_key=None, sort_dir=None):
    """Get matching resource paymentmethods.

    Return a list of the specified columns for all resource paymentmethods that
    match the specified filters.
    :param context: The security context
    :param filters: Filters to apply. Defaults to None.
    :param limit: Maximum number of resource paymentmethods to return.
    :param marker: the last item of the previous page; we
                    return the next
    :param sort_key: Attribute by which results should be sorted.
                    (asc, desc)
    :returns: A list of tuples of the specified columns.
    """
    return _get_dbdriver_instance().list_resource_paymentmethods(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_resource_paymentmethod(context, values):
    """Create a new resource paymentmethod.

    :param context: The security context
    :param values: A dict containing several items used to identify and
                   track the resource paymentmethod, and several dicts which are
                   passed into the Drivers when managing this resource
                   paymentmethod.
    :returns: A resource paymentmethod.
    """
    return _get_dbdriver_instance().create_resource_paymentmethod(context, values)


@profiler.trace("db")
def get_resource_paymentmethod(context, paymentmethod_ident):
    """Return a resource paymentmethod.

    :param context: The security context
    :param paymentmethod_ident: The uuid or name of a resource paymentmethod.
    :returns: A resource paymentmethod.
    """
    return _get_dbdriver_instance().get_resource_paymentmethod(
        context, paymentmethod_ident)


@profiler.trace("db")
def destroy_resource_paymentmethod(context, paymentmethod_id):
    """Destroy a resource paymentmethod and all associated interfaces.

    :param context: Request context
    :param paymentmethod_id: The id or uuid of a resource paymentmethod.
    """
    return _get_dbdriver_instance().destroy_resource_paymentmethod(
        context, paymentmethod_id)


@profiler.trace("db")
def update_resource_paymentmethod(context, paymentmethod_id, values):
    """Update properties of a resource paymentmethod.

    :context: Request context
    :param paymentmethod_id: The id or uuid of a resource paymentmethod.
    :values: The properties to be updated
    :returns: A resource paymentmethod.
    :raises: ResourcePaymentmethodNotFound
    """
    return _get_dbdriver_instance().update_resource_paymentmethod(
        context, paymentmethod_id, values)
...
@profiler.trace("db")
def create_inventory(context, paymentmethod_id, values):
    """Create a new inventory.

    :param context: The security context
    :param paymentmethod_id: The id of a resource paymentmethod.
    :param values: A dict containing several items used to identify
