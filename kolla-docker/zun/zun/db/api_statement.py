...
@profiler.trace("db")
def list_statements(context, filters=None, limit=None, marker=None,
                    sort_key=None, sort_dir=None):
    """List matching statements.

    Return a list of the specified columns for all statements that match
    ...
    """
    return _get_dbdriver_instance().list_statements(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_statement(context, values):
    """Create a new statement.

    :param context: The security context
    :param values: A dict containing several items used to identify
                   and track the statement, and several dicts which are
                   passed
                   into the Drivers when managing this statement. For
                   example:
                   ::
                    {
    ...
    :returns: A statement.
    """
    return _get_dbdriver_instance().create_statement(context, values)


@profiler.trace("db")
def get_statement_by_uuid(context, statement_uuid):
    """Return a statement.

    :param context: The security context
    :param statement_uuid: The uuid of a statement.
    :returns: A statement.
    """
    return _get_dbdriver_instance().get_statement_by_uuid(
        context, statement_uuid)


@profiler.trace("db")
def get_statement_by_name(context, statement_name):
    """Return a statement.

    :param context: The security context
    :param statement_name: The name of a statement.
    :returns: A statement.
    """
    return _get_dbdriver_instance().get_statement_by_name(
        context, statement_name)


@profiler.trace("db")
def destroy_statement(context, statement_id):
    """Destroy a statement and all associated interfaces.

    :param context: Request context
    :param statement_id: The id or uuid of a statement.
    """
    return _get_dbdriver_instance().destroy_statement(context, statement_id)


@profiler.trace("db")
def update_statement(context, statement_id, values):
    """Update properties of a statement.
    ...
    """
    process_date("billing_begin_date", values)
    process_date("billing_end_date", values)
    return _get_dbdriver_instance().update_statement(
        context, statement_id, values)
...
@profiler.trace("db")
def list_resource_statements(context, filters=None, limit=None, marker=None,
                            sort_key=None, sort_dir=None):
    """Get matching resource statements.

    Return a list of the specified columns for all resource statements that
    match the specified filters.
    :param context: The security context
    :param filters: Filters to apply. Defaults to None.
    :param limit: Maximum number of resource statements to return.
    :param marker: the last item of the previous page; we
                    return the next
    :param sort_key: Attribute by which results should be sorted.
                    (asc, desc)
    :returns: A list of tuples of the specified columns.
    """
    return _get_dbdriver_instance().list_resource_statements(
        context, filters, limit, marker, sort_key, sort_dir)


@profiler.trace("db")
def create_resource_statement(context, values):
    """Create a new resource statement.

    :param context: The security context
    :param values: A dict containing several items used to identify and
                   track the resource statement, and several dicts which are
                   passed into the Drivers when managing this resource
                   statement.
    :returns: A resource statement.
    """
    return _get_dbdriver_instance().create_resource_statement(context, values)


@profiler.trace("db")
def get_resource_statement(context, statement_ident):
    """Return a resource statement.

    :param context: The security context
    :param statement_ident: The uuid or name of a resource statement.
    :returns: A resource statement.
    """
    return _get_dbdriver_instance().get_resource_statement(
        context, statement_ident)


@profiler.trace("db")
def destroy_resource_statement(context, statement_id):
    """Destroy a resource statement and all associated interfaces.

    :param context: Request context
    :param statement_id: The id or uuid of a resource statement.
    """
    return _get_dbdriver_instance().destroy_resource_statement(
        context, statement_id)


@profiler.trace("db")
def update_resource_statement(context, statement_id, values):
    """Update properties of a resource statement.

    :context: Request context
    :param statement_id: The id or uuid of a resource statement.
    :values: The properties to be updated
    :returns: A resource statement.
    :raises: ResourceStatementNotFound
    """
    return _get_dbdriver_instance().update_resource_statement(
        context, statement_id, values)
...
@profiler.trace("db")
def create_inventory(context, statement_id, values):
    """Create a new inventory.

    :param context: The security context
    :param statement_id: The id of a resource statement.
    :param values: A dict containing several items used to identify
