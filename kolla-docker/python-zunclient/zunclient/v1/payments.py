...
CREATION_ATTRIBUTES = ['id', 'statement_id', 'amount', 'payment_date', 'payment_method_id', 'status', 'displayname', 'displayname2',
...
class Payment(base.Resource):
    def __repr__(self):
        return "<Payment %s>" % self._info
...
class ContainerManager(base.Manager):
    ...
    def list(self, marker=None, limit=None, sort_key=None,
        ...
        LOG.debug('zunclient payment payment path=%s,  xxx list args xxx yyyy zzzzzzzzzzz', self._path(path))
        if limit is None:
