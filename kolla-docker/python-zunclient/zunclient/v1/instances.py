...
CREATION_ATTRIBUTES = ['id', 'user_id', 'instance_type_id', 'provider_vm_id', 'current_status', 'current_status_time', 'create_time', 'displayname', 'displayname2', 'displayname3',
...
class ContainerManager(base.Manager):
    ...
    def list(self, marker=None, limit=None, sort_key=None,
        ...
        LOG.debug('zunclient instance instance path=%s,  xxx list args xxx yyyy zzzzzzzzzzz', self._path(path))
        if limit is None:
