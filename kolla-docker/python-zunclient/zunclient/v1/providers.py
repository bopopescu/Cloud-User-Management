...
CREATION_ATTRIBUTES = ['id', 'provider', 'displayname',
...
class ContainerManager(base.Manager):
    ...
    def list(self, marker=None, limit=None, sort_key=None,
        ...
        LOG.debug('zunclient provider provider path=%s,  xxx list args xxx yyyy zzzzzzzzzzz', self._path(path))
        if limit is None:
