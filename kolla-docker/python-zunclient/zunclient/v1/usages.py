...
CREATION_ATTRIBUTES = ['id', 'user_id', 'instance_id', 'compute_rate_id', 'storage_rate_id',
                       'start_time', 'stop_time', 'duration', 'cost', 'displayname', 'displayname2', 'displayname3', 'displayname4',
...
class ContainerManager(base.Manager):
    ...
    def list(self, marker=None, limit=None, sort_key=None,
        ...
        LOG.debug('zunclient usage usage path=%s,  xxx list args xxx yyyy zzzzzzzzzzz', self._path(path))
        if limit is None:
