...
(function() {
  ...
  /**
   * @ngdoc controller
   * @name horizon.dashboard.container.providerregions.workflow.scheduler-hints
   * @description
  ...
  angular
    ...
    .controller('horizon.dashboard.container.providerregions.workflow.scheduler-hints',
