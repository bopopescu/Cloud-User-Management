...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.container.providerregions.create.service
   * @description Service for the container create modal
   */
  angular
    .module('horizon.dashboard.container.providerregions')
    .factory('horizon.dashboard.container.providerregions.create.service', createService);
  ...
  function createService(
    ...
    function submit(context) {
      // context.model.name=context.model.providerregion_name+"_"+context.model.name;
      context.model = cleanNullProperties(context.model);
      return zun.createProviderregion(context.model).then(success);
    }
