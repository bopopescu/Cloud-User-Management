...
(function() {
  ...
  /**
   * @ngDoc factory
   * @name horizon.dashboard.container.servers.delete-force.service
   * @Description
  ...
  angular
    ...
    .factory('horizon.dashboard.container.servers.delete-force.service', deleteForceService);
  ...
  deleteForceService.$inject = [
    ...
    'horizon.dashboard.container.servers.events',
  ...
  function deleteForceService(
    ...
    function createResult(deleteModalResult) {
      ...
      if (result.result.failed.length === 0 && result.result.deleted.length > 0) {
        $location.path('/project/container/servers');
      } else {
