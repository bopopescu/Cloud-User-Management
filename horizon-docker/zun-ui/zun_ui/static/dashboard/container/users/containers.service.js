...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.container.users.service', containersService);
  ...
  function containersService(detailRoute, zun) {
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Zun::User/' + item.id;
    }
     ...
     * users.  This is used in displaying lists of containers.
     */
    function getContainersPromise(params) {
      return zun.getUsers(params).then(modifyResponse);
    }
