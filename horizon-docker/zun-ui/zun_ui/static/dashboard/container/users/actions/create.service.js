...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.container.users.create.service
   * @description Service for the container create modal
   */
  angular
    .module('horizon.dashboard.container.users')
    .factory('horizon.dashboard.container.users.create.service', createService);
  ...
  function createService(
    ...
    function submit(context) {
      if(!validateEmail(context.model.user_name)){
        ...
        //context.model.name=context.model.user_name+"_"+context.model.name;
        context.model = cleanNullProperties(context.model);
        return zun.createUser(context.model).then(success);
       }
    }
