...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.container.carriers.service', containersService);
  ...
  function containersService(detailRoute, zun) {
    ...
    function getDetailsPath(item) {
      return detailRoute + 'OS::Zun::Carrier/' + item.id;
    }
    ...
    function getContainerPromise(identifier) {
      return zun.getCarrier(identifier);
    }

    /*
     * @ngdoc function
     * @name getCarriersPromise
     * @description
     * Given filter/query parameters, returns a promise for the matching
     * carriers.  This is used in displaying lists of containers.
     */
    function getContainersPromise(params) {
      return zun.getCarriers(params).then(modifyResponse);
    }
