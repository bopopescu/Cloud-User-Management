...
class Carrier(base.Resource):
    def __repr__(self):
        return "<Carrier %s>" % self._info
...
class ContainerManager(base.Manager):
    ...
    def list(self, marker=None, limit=None, sort_key=None,
        ...
        LOG.debug('zunclient carrier carrier path=%s,  xxx list args xxx yyyy zzzzzzzzzzz', self._path(path))
        if limit is None:
