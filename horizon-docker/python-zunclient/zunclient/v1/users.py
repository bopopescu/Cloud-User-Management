...
CREATION_ATTRIBUTES = ['id', 'user_name', 'last_name', 'first_name', 'middle_name', 'password', 'account_status',
                       'failed_attempt', 'last_login_method', 'current_user_charge_tier', 'admin_ind',
