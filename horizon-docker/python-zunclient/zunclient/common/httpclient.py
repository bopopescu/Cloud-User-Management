...
class SessionClient(adapter.LegacyJsonAdapter):
    ...
    def __init__(self, user_agent=USER_AGENT, logger=LOG,
        ...
        self.api_version = api_version or api_versions.APIVersion()
        LOG.debug("SessionClient args=%s,kwargs=%s" % (args, kwargs))
    ...
    def _http_request(self, url, method, **kwargs):
        ...
        LOG.debug('httpclient endpoint_filter args xxx endpoint_filter=%s,url=%s,method=%s,kwargs=%s' % (endpoint_filter, url, method, kwargs))
