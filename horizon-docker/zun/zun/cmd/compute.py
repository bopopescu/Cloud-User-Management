...
def main():
    ...
    LOG.debug('start compute server topic=%s,host=%s,endpoints=%s,server=%s,_server=%s', CONF.compute.topic, CONF.host,  endpoints[0].__dict__, server.__dict__,server._server)
