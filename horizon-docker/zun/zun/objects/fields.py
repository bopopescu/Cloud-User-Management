...
class CarrierStatusField(fields.BaseEnumField):
    AUTO_TYPE = ContainerStatus()

class ProviderregionStatusField(fields.BaseEnumField):
    AUTO_TYPE = ContainerStatus()

class UserStatusField(fields.BaseEnumField):
    AUTO_TYPE = ContainerStatus()
...
class CarrierRuntimeField(fields.BaseEnumField):
    AUTO_TYPE = ContainerRuntime()

class ProviderregionRuntimeField(fields.BaseEnumField):
    AUTO_TYPE = ContainerRuntime()

class UserRuntimeField(fields.BaseEnumField):
    AUTO_TYPE = ContainerRuntime()
