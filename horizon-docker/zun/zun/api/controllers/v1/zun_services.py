...
class ZunServiceController(base.Controller):
    ...
    def get_all(self, **kwargs):
        ...
        """
        LOG.debug('zun_services get_all xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx kwargs =%s  xxxxxxxxxxxxxxxxxxxxxxxxx XXXXXXXXXX.',
                  kwargs)
    ...
    def delete(self, host, binary):
        ...
        """
        LOG.debug(
            'zun_services delete xxxxxxxxxxxxx host =%s   XXXXXXXXXX.',host)
        context = pecan.request.context
