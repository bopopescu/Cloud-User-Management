...
from zun.api.controllers.v1 import carriers as carrier_controller
...
class Controller(controllers_base.Controller):
    ...
    carriers = carrier_controller.ContainersController()
    ...
    @pecan.expose('json')
    def get(self):
        LOG.debug('controller init xxxxxxxxxxxxxxxxxxxxxxxxx XXXXXXXXXX.')
        return V1.convert()
