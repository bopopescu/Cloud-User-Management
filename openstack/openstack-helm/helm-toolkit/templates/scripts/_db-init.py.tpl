...
#        with open(os_conf, 'r') as fin:
#            print fin.read()
#        with open("/etc/zun/zun.conf", 'r') as fin:
#            print fin.read()
...
try:
    ...
    logger.info("Tested connection to DB {0}:{1} as {2}".format(host, port, root_user))
except:
...
try:
    ...
    logger.info(user_engine, database, user, password)
